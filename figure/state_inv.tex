...
\begin{tikzpicture}[state/.style={circle, draw, minimum size=.8cm}, node distance=.8cm]
	...
	\node(a1) [state, left =of a0] {$1$};
	\node(a2) [state, above left =of a1] {$2$};
	\node(a3) [state, left =of a2] {$3$};
	\node(a4) [state, left =of a3] {$4$};
	\node(a5) [state, below left =of a1] {$5$};
	\node(a7) [state, below left =of a4] {$7$};
	\node(a6) [state, below right = of a7] {$6$};
	\node(a8) [state, above left =of a7] {$8$};
	\node(a9) [state, left =of a8] {$9$};
	\node(a10) [state, left =of a9] {$10$};
	\node(a11) [state, below left =of a7] {$11$};
	\node(a12) [state, left =of a11] {$12$};
	\node(a13) [state, left =of a12] {$13$};
	\node(a14) [state, below left =of a10] {$14$};
	\node(a15) [state, double, double distance=.8mm, left =of a14] {$15$};
	...
	\draw [->] (a5) to [bend left] node[midway, above] {$\epsilon$} (a6) ;
	...
	\draw [->] (a8) to [bend left] node[midway, below] {$\epsilon$} (a9) ;
	\draw [->] (a9) to [bend left] node[midway, below] {$\epsilon$} (a10) ;
	...
	\draw [->, very thick, draw=mLightBrown] (a4) to [bend left=45] node[midway, above] {$\epsilon$} (a2);
	\draw [->, very thick, draw=mLightBrown] (a13) to [bend right=45] node[midway, above] {$\epsilon$} (a11);
