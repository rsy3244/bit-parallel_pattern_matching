...
\begin{tikzpicture}[state/.style={circle, draw, minimum size=.8cm}, node distance=.8cm]
	...
	\draw [->, very thick, draw=mLightBrown] (a4) to [bend right=45] node[midway, above] {$\epsilon$} (a2);
	\draw [->, very thick, draw=mLightBrown] (a13) to [bend left=45] node[midway, above] {$\epsilon$} (a11);
